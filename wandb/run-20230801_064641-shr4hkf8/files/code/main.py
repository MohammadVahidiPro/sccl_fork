...
def run(args):
    print(args)
    with wb.init(project="sccl-2021", mode="online", group=args.dataname, config=args) as current_run:
        ...
        if True:
            checkpoint = "D:\text_clustering_paper\my-forks\sccl_fork\models\saved_models\searchsnippets\ldlehh3y-minilm6-best-model.pth"
